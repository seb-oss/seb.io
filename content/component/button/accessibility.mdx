...
- Contrast: Passed
- Aria-label: Passed
- Keyboard navigation: Failed - no visual trigger effect on space
- Darkmode: Passed
- Focus: Passed
...
### Keyboard navigation
Uses default navigation: trigger on key-up with space, trigger on enter on key-down.
...
<Row>
<Col>
    <FigmaSVG node="259-4131" caption="Icon buttons with accessible labels, label attributes" />
</Col>
<Col>
    <FigmaSVG node="259-4140" caption="Buttons with accessible labels." />
</Col>
</Row>
