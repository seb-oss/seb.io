...
<Row>
<Col><FigmaSVG node="258-3237" caption="Next <SE>(Nästa)</SE>" /></Col>
<Col><FigmaSVG node="258-3242" caption="Back <SE>(Tillbaka)</SE>" /></Col>
<Col><FigmaSVG node="258-3247" caption="Cancel <SE>(Avbryt)</SE>" /></Col>
</Row>
<Row>
<Col><FigmaSVG node="258-3280" caption="Delete <SE>(Ta bort)</SE>" /></Col>
<Col><FigmaSVG node="258-3285" caption="Change <SE>(Ändra)</SE> – takes the user to edit mode." /></Col>
<Col><FigmaSVG node="258-3290" caption="Save <SE>(Spara)</SE>" /></Col>
</Row>
<Row>
<Col><FigmaSVG node="258-3908" caption="Close <SE>(Stäng)</SE> – closing a dialog, modal, slide-out etc." /></Col>
<Col><FigmaSVG node="258-3911" caption="Sign <SE>(Signera)</SE> – signing with BankID." /></Col>
<Col><FigmaSVG node="258-3913" caption="Identify yourself <SE>(Identifiera dig)</SE> – identifying with BankID." /></Col>
</Row>
