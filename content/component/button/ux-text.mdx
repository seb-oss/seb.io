...
<Row>
<Col><FigmaSVG node="1612-8563" caption="Next/<SE>Nästa</SE> – Takes the user to the next step in a flow." /></Col>
<Col><FigmaSVG node="1612-8541" caption="Back/<SE>Tillbaka</SE> – Takes the user to the previous step in a flow or aborts the action in dialog and slide outs (used when Cancel or something similar is the primary action)." /></Col>
<Col><FigmaSVG node="1612-8782" caption="Cancel/<SE>Avbryt</SE> – Cancels the action." /></Col>
</Row>
<Row>
<Col><FigmaSVG node="1612-8544" caption="Delete/<SE>Ta bort</SE> – The user wants to delete something (often in red text and with an illustration of a trash can)." /></Col>
<Col><FigmaSVG node="1612-8548" caption="Change/<SE>Ändra</SE> – The user wants to change something." /></Col>
<Col><FigmaSVG node="1612-8551" caption="Save/<SE>Spara</SE> – The user wants to save something, for instance, a change." /></Col>
</Row>
<Row>
<Col><FigmaSVG node="1612-8557" caption="Close/<SE>Stäng</SE> – To close a dialog, modal, slide out etc." /></Col>
<Col><FigmaSVG node="1612-8554" caption="Sign/<SE>Signera</SE> – The user is signing with BankID." /></Col>
<Col><FigmaSVG node="1612-8560" caption="Identify yourself/<SE>Identifiera dig</SE> – The user is identifying themselves with BankID" /></Col>
</Row>
<hr />
...
Don’t
<ul>
    <li>Avoid the formal *Perform/<SE>Utför</SE>* and the vague *Okay/<SE>Okej</SE>*</li>
