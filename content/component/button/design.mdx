...
<Col>
    <FigmaSVG 
        node="258-2977" 
        caption="A primary button has a solid container."
    />
</Col>
<Col>
    <FigmaSVG 
        node="258-2986" 
        caption="A secondary button has a transparent container and 1 px border."
    />
</Col>
<Col>
    <FigmaSVG 
...
<Row>
<Col>
    <FigmaSVG node="264-6654" caption="Text" />
...
<Col>
    <FigmaSVG node="264-6656" caption="Container" />
...
<Col>
    <FigmaSVG node="264-6658" caption="Border" />
...
<Row>
<Col>
    <FigmaSVG node="264-7238" caption="Leading element" />
...
<Col>
    <FigmaSVG node="264-7241" caption="Trailing element" />
...
<Col>
    <FigmaSVG node="264-7245" caption="Spacing/Padding" />
...
<Row>
<Col>
    <FigmaSVG node="264-7314" caption="State indicators" />
...
<Col>
    <FigmaSVG node="264-7319" caption="Accessibility features" />
...
<Row>
    ...
    <Col> <FigmaSVG node="266-7387" caption="Leading elements that support the button text." /></Col>
</Row>
...
<Row>
    ...
    <Col> <FigmaSVG node="266-7448" caption="The trailing element gives a hint on what is about to happen on click." /></Col>
</Row>
