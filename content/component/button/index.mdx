...
Used to group a set of actions that would otherwise be separate buttons. Clicking the arrow-part will trigger a contextual menu with actionable options. 

Comes in both primary and secondary.
...
Used to both signal what or which categories an item belong to, and to work as navigation to see other items belonging to the same category.
  ...
  <Col>
    <FigmaSVG node="227-18446" caption="Two categories" />
  </Col>
</Row> */}
