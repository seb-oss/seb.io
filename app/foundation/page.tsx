            ...
            <Col xs={12} md={6}>
              ...
              <Accordion>
                <AccordionItem id="timeless" label="Timeless" labelElementLevel={3}>
                  <p>Embracing a modern aesthetic, the Green Design System radiates elegance. Its visual elements are a harmonious blend of contemporary design principles, ensuring a fresh and relevant appearance that stands the test of time.</p>
                </AccordionItem>
                <AccordionItem id="to-the-point" label="To the point" labelElementLevel={3}>
                  <p>Elegance is found in simplicity. The Green Design System champions an uncluttered approach, where every visual element serves a purpose. The result is an interface that feels effortless, allowing users to navigate seamlessly without unnecessary distractions.</p>
                </AccordionItem>
                <AccordionItem id="confidence-in-simplicity" label="Confidence in simplicity" labelElementLevel={3}>
                  <p>In the world of design, confidence shines through simplicity. The Green Design System adheres to the philosophy that "less is more." By stripping away the superfluous, it exudes confidence, allowing the core essence of the design to take center stage.</p>
                </AccordionItem>
                <AccordionItem id="attention-to-detail" label="Attention to detail" labelElementLevel={3}>
                  <p>Just as in our business operations, the Green Design System is meticulous in its attention to detail. Every pixel, every color, and every interaction is carefully considered, contributing to a visually polished and refined user interface.</p>
                </AccordionItem>
                <AccordionItem id="effortless" label="Effortless" labelElementLevel={3}>
            ...
            <Col xs={12} md={6}>
              ...
              <Accordion>
                <AccordionItem id="features" label="Consistency" labelElementLevel={3}>
                  <p>The Green Design System ensures a seamless and consistent visual experience across our entire product suite. Every element, from buttons to typography, is meticulously crafted, creating a cohesive and polished user interface.</p>
                </AccordionItem>
                <AccordionItem id="consistency" label="Efficiency" labelElementLevel={3}>
                  <p>With an extensive library of reusable components, Green Design System empowers our teams to design and develop with speed and precision. This efficiency allows for more time spent on creative innovation and less on repetitive tasks, ultimately reducing time-to-market.</p>
                </AccordionItem>
                <AccordionItem id="efficiency" label="Adaptability" labelElementLevel={3}>
                ...
                <AccordionItem id="user-centric-principles" label="User-Centric Principles" labelElementLevel={3}>
                  <p>Rooted in user-centric design principles, our Design System places the user at the forefront. From accessible color choices to responsive design elements, we prioritize inclusivity and user satisfaction, ensuring that our products are both functional and enjoyable.</p>
                </AccordionItem>
                <AccordionItem id="components-and-styles" label="Components and Styles" labelElementLevel={3}>
                  <p>Explore a palette inspired by the versatility and vibrancy of our brand promise, typography and iconography are carefully chosen for both style and functionality. Our library of components is a playground of possibilities, designed to create interfaces that are not only visually appealing but also accessible and highly UX centered.</p>
                </AccordionItem>
                <AccordionItem id="implementation" label="Implementation" labelElementLevel={3}>
