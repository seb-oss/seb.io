            ...
            <Col xs={12} md={6}>
              ...
              <Accordion>
                <AccordionItem label="Figma libraries" labelElementLevel={3}>
                  <p>Figma is our go to design tool and we maintain multiple Figma libraries, components and variables.</p>
                </AccordionItem>
                <AccordionItem label="Multiple code implementations" labelElementLevel={3}>
                  <p>Green supports both Angular and React but the core is built with Webcomponents using Lit.</p>
                </AccordionItem>
                <AccordionItem label="Documenting design and code patters" labelElementLevel={3}>
                  <p>We use this site to document how to use our design kits and coded components as well as our design patterns and general user interface guidelines.</p>
                </AccordionItem>
                <AccordionItem label="Supporting our users" labelElementLevel={3}>
                  <p>We know that learing and using a new system can be hard and we are here to help and make your journey in the design system a more pleasant one.</p>
                </AccordionItem>
                <AccordionItem label="Coaching Green users" labelElementLevel={3}>
                  <p>Some problems that you run into can be too large to use your keyboard to explain so we have ongoing coaching sessions at your disposal. We have two different coaching session regarding design and development at SEB: Green Coaching and CX Coaching. Both of these meetings are slot based meeting where you bring your questions and problems and discuss them with members
                    from the Green Design System team.</p>
                  <Spacing direction="vertical" size={7} />
                  <ul>
                    <li>– Book <a href="https://teams.microsoft.com/l/entity/0d820ecd-def2-4297-adad-78056cde7c78/_djb2_msteams_prefix_4065088102?context=%7B%22channelId%22%3A%2219%3A33f450cae2764531930c4eca19aa4c26%40thread.tacv2%22%7D&groupId=3ad3eb8f-ab23-44e6-9b61-d08fee172513&tenantId=9a8ff9e3-0e35-4620-a724-e9834dc50b51" target="_blank">Green Coaching</a></li>
                    <li>–Book <a href="https://teams.microsoft.com/l/entity/0d820ecd-def2-4297-adad-78056cde7c78/_djb2_msteams_prefix_43486807?context=%7B%22channelId%22%3A%2219%3A33f450cae2764531930c4eca19aa4c26%40thread.tacv2%22%7D&groupId=3ad3eb8f-ab23-44e6-9b61-d08fee172513&tenantId=9a8ff9e3-0e35-4620-a724-e9834dc50b51" target="_blank">CX Coaching</a></li>
                  </ul>
                </AccordionItem>
              </Accordion>
            </Col>
