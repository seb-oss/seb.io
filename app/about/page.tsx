      ...
      <Stack gap="7.5rem">
        ...
        <Row>
          ...
          <Col xs={12} md={6}>
            ...
            <p className="paragraph-medium text-secondary">
              The design system is called Green as an homage to SEB being viewed
              as the {"green bank"} with green as a primary colour for the brand
              and the bank. The bank also plays a great role in the transition
              to a{" "}
              <Link
          ...
          <Col xs={12} md={6}>
            ...
            <Accordion>
              <AccordionItem label="Figma libraries" labelElementLevel={3}>
                <p>
                  Figma is our go to design tool and we maintain multiple Figma
                  libraries, components and variables.
                </p>
              </AccordionItem>
              <AccordionItem
              ...
              <AccordionItem label="Supporting our users" labelElementLevel={3}>
                <p>
                  We know that learing and using a new system can be hard and we
                  are here to help and make your journey in the design system a
                  more pleasant one.
                </p>
              </AccordionItem>
              <AccordionItem label="Coaching Green users" labelElementLevel={3}>
                <p>
                  ...
                  regarding design and development at SEB: Green Coaching and CX
                  Coaching. Both of these meetings are slot based meeting where
                  you bring your questions and problems and discuss them with
                  members from the Green Design System team.
                </p>
