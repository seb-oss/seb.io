      ...
      >
        <Grid columns={1} gapBlock="large">
          ...
          <p className="paragraph-medium text-secondary">
            ...
            affect the {`reader's`} concentration on the content and
            understanding of the text. Because our texts are correct, our
            credibility with customers and other visitors (=potential customers)
            increases. We follow:
          </p>
          <section>
            ...
            <p>
              {"SEB's "}
              <Link
                href="https://brand.seb.se/point/en/seb/component/default/82393"
                target="_blank"
              >
                Written ID
              </Link>
              {
                " is our guiding light, and it forms the basis for all our communication, including UX writing."
              }
            </p>
            <br />
          ...
          <section>
            ...
            <br />
            <br />
            The UX texts help the user, or customer, to navigate apps, websites,
            and other digital products. They are one part of many in a final
            design. UX texts focus on accessibility, they are short and to the
            point without losing any important information. They are
            user-friendly, contextually appropriate and with the right tone of
            voice. The UX texts should solve a user problem and meet the
            business goals.
            <br />
            <br />
            ...
            <br />
            <br />
            Good UX writing is like a personal guide that acts in the background
            and helps customers understand how to act and navigate. It ensures
            that customers do not end up in situations where they feel stupid or
            underestimated. Really good UX writing will rather make them feel
            satisfied because they succeed in finishing a task without
            unnecessary thresholds.
          </section>
          <section>
          ...
          <section>
            ...
            <ul>
              <li>
                {"Språkkonsulterna: "}
                <Link href="mailto:info@sprakkonsulterna.se" target="_blank">
                  info@sprakkonsulterna.se
                </Link>
              </li>
              <li>
                {"Lionbridge: "}
                <Link href="mailto:jakob.nordby@lionbridge.com" target="_blank">
          ...
          <section>
            ...
            <p>
              {
                "When you need help with tone-of-voice, instructions, vocabulary or a UX writer to work with, please don’t hesitate to contact the UX writing team. Reach out in the Teams channels "
              }
              <Link
                href="https://teams.microsoft.com/l/channel/19%3adc26cb18c8dd48e7bd7c2b1b65358cfc%40thread.tacv2/UX%2520Writing?groupId=3ad3eb8f-ab23-44e6-9b61-d08fee172513&tenantId=9a8ff9e3-0e35-4620-a724-e9834dc50b51"
                target="_blank"
              >
                UX writing
              </Link>
              {" in Green Design System or "}
              <Link
                href="https://teams.microsoft.com/l/channel/19%3a2087564862f64972946b3b11dfa23d0c%40thread.tacv2/UX%2520Writing?groupId=8dda903f-8371-4d49-922d-2d81a24a869b&tenantId=9a8ff9e3-0e35-4620-a724-e9834dc50b51"
                target="_blank"
              >
                UX writing
              </Link>
              {
                " in CX Community, or if you already have a contact or dedicated writer for your team or product, simply contact that person."
              }
            </p>
          </section>
        </Grid>
